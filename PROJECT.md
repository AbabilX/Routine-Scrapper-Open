...
- Shared cute shell: `lib/ui/components/cute_page.dart` (+ header, blobs, empty hint). About uses full scroll; Teacher / Empty pin search+filters and scroll only the results area.
