...
class CuteFacePainter extends CustomPainter {
  ...
  void _cat(Canvas canvas, double w, double h) {
    ...
    _ear(canvas, Offset(w * 0.22, h * 0.08), Offset(w * 0.12, h * 0.38), Offset(w * 0.36, h * 0.28), ear);
    _ear(canvas, Offset(w * 0.78, h * 0.08), Offset(w * 0.88, h * 0.38), Offset(w * 0.64, h * 0.28), ear);
    _eyes(canvas, w, h, y: 0.44, radius: 0.048);
    _whisker(canvas, w, h, left: true);
    _whisker(canvas, w, h, left: false);
    canvas.drawCircle(Offset(w * 0.5, h * 0.58), w * 0.035, Paint()..color = rose);
  ...
  void _bunny(Canvas canvas, double w, double h) {
    ...
    _ear(canvas, Offset(w * 0.32, h * 0.02), Offset(w * 0.22, h * 0.34), Offset(w * 0.42, h * 0.3), ear);
    _ear(canvas, Offset(w * 0.68, h * 0.02), Offset(w * 0.58, h * 0.3), Offset(w * 0.78, h * 0.34), ear);
    _ear(canvas, Offset(w * 0.32, h * 0.06), Offset(w * 0.26, h * 0.28), Offset(w * 0.38, h * 0.26), inner);
    _ear(canvas, Offset(w * 0.68, h * 0.06), Offset(w * 0.62, h * 0.26), Offset(w * 0.74, h * 0.28), inner);
    _eyes(canvas, w, h, y: 0.46);
    canvas.drawCircle(Offset(w * 0.5, h * 0.6), w * 0.03, Paint()..color = rose);
  ...
  void _chick(Canvas canvas, double w, double h) {
    ...
    canvas.drawCircle(Offset(w * 0.22, h * 0.62), w * 0.07, Paint()..color = peach.withValues(alpha: 0.7));
    canvas.drawCircle(Offset(w * 0.78, h * 0.62), w * 0.07, Paint()..color = peach.withValues(alpha: 0.7));
  }
  ...
  void _deer(Canvas canvas, double w, double h) {
    ...
    canvas.drawLine(Offset(w * 0.32, h * 0.28), Offset(w * 0.22, h * 0.08), antler);
    canvas.drawLine(Offset(w * 0.26, h * 0.16), Offset(w * 0.16, h * 0.12), antler);
    canvas.drawLine(Offset(w * 0.68, h * 0.28), Offset(w * 0.78, h * 0.08), antler);
    canvas.drawLine(Offset(w * 0.74, h * 0.16), Offset(w * 0.84, h * 0.12), antler);
    _eyes(canvas, w, h, y: 0.46, radius: 0.045);
    canvas.drawCircle(Offset(w * 0.5, h * 0.6), w * 0.028, Paint()..color = rose);
    _smile(canvas, w, h, top: 0.58, width: 0.2);
  }

  void _fox(Canvas canvas, double w, double h) {
    final ear = Paint()..color = ink;
    _ear(canvas, Offset(w * 0.2, h * 0.04), Offset(w * 0.1, h * 0.36), Offset(w * 0.36, h * 0.3), ear);
    _ear(canvas, Offset(w * 0.8, h * 0.04), Offset(w * 0.9, h * 0.36), Offset(w * 0.64, h * 0.3), ear);
    canvas.drawCircle(Offset(w * 0.5, h * 0.62), w * 0.16, Paint()..color = surface);
  ...
  void _wolf(Canvas canvas, double w, double h) {
    final ear = Paint()..color = ink;
    _ear(canvas, Offset(w * 0.24, h * 0.02), Offset(w * 0.12, h * 0.34), Offset(w * 0.38, h * 0.3), ear);
    _ear(canvas, Offset(w * 0.76, h * 0.02), Offset(w * 0.88, h * 0.34), Offset(w * 0.62, h * 0.3), ear);
    _eyes(canvas, w, h, y: 0.42, radius: 0.042);
    canvas.drawOval(
      Rect.fromCenter(center: Offset(w * 0.5, h * 0.62), width: w * 0.28, height: h * 0.16),
      Paint()..color = surface,
    );
  ...
  void _bear(Canvas canvas, double w, double h) {
    canvas.drawCircle(Offset(w * 0.22, h * 0.22), w * 0.14, Paint()..color = ink.withValues(alpha: 0.18));
    canvas.drawCircle(Offset(w * 0.78, h * 0.22), w * 0.14, Paint()..color = ink.withValues(alpha: 0.18));
    canvas.drawCircle(Offset(w * 0.5, h * 0.62), w * 0.18, Paint()..color = surface);
    _eyes(canvas, w, h, y: 0.42);
    canvas.drawCircle(Offset(w * 0.5, h * 0.58), w * 0.04, Paint()..color = ink);
    _smile(canvas, w, h, top: 0.6, width: 0.22);
  }

  void _bald(Canvas canvas, double w, double h, {required _BaldVariant variant}) {
    canvas.drawOval(
      Rect.fromCenter(center: Offset(w * 0.38, h * 0.16), width: w * 0.22, height: h * 0.1),
      Paint()..color = surface.withValues(alpha: 0.7),
    );
    canvas.drawCircle(Offset(w * 0.18, h * 0.52), w * 0.07, Paint()..color = ink.withValues(alpha: 0.08));
    canvas.drawCircle(Offset(w * 0.82, h * 0.52), w * 0.07, Paint()..color = ink.withValues(alpha: 0.08));
  ...
  void _glasses(Canvas canvas, double w, double h) {
    ...
    canvas.drawLine(Offset(w * 0.48, h * 0.44), Offset(w * 0.52, h * 0.44), paint);
  }
  ...
  void _brows(Canvas canvas, double w, double h) {
    final paint = Paint()
      ...
      ..strokeWidth = w * 0.035
      ..strokeCap = StrokeCap.round;
    canvas.drawLine(Offset(w * 0.28, h * 0.32), Offset(w * 0.42, h * 0.3), paint);
    canvas.drawLine(Offset(w * 0.58, h * 0.3), Offset(w * 0.72, h * 0.32), paint);
  }
  ...
  void _eyes(
    ...
    final r = w * radius;
    _eye(canvas, Offset(w * 0.36, h * y), r, (leftOpen * (1 - blink * 0.92)).clamp(0.12, 1));
    _eye(canvas, Offset(w * 0.64, h * y), r, (rightOpen * (1 - blink * 0.92)).clamp(0.12, 1));
  }
  ...
  void _smile(Canvas canvas, double w, double h, {required double top, double width = 0.24}) {
    final smile = Paint()
      ..color = ink
      ..style = PaintingStyle.stroke
      ..strokeWidth = w * 0.045
  ...
  void _whisker(Canvas canvas, double w, double h, {required bool left}) {
    ...
    canvas.drawLine(Offset(w * 0.5 + dir * w * 0.12, h * 0.58), Offset(x, h * 0.52), paint);
    canvas.drawLine(Offset(w * 0.5 + dir * w * 0.12, h * 0.62), Offset(x, h * 0.66), paint);
  }
